...
export const metadataIntentLabelsSchema = zodToJsonSchema(
  z.object({
...
const destinationRecordSchemaList = z.object({
  table: z
    .array(destinationRecordSchemaObject)
...
export const adSchema = zodToJsonSchema(
  z
    .object({
